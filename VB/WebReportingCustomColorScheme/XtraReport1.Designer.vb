Namespace WebReportingCustomColorScheme
    Partial Public Class XtraReport1
        ...
        Private Sub InitializeComponent()
            ...
            ' lbCategory
            ' 
            Me.lbCategory.ExpressionBindings.AddRange(New DevExpress.XtraReports.UI.ExpressionBinding() { _
                New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CategoryName]"), _
                New DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Bookmark", "[CategoryName]") _
            })
            ...
            ' sqlDataSource1
            ' 
            Me.sqlDataSource1.ConnectionName = "NWind.mdf"
